...
_deprecated_file( basename( __FILE__ ), '15.0.0', '', esc_html__( 'BuddyPress Site-Wide Notices became Member Notices, please use the `BP_Members_Notice()` class instead.', 'buddypress' ) );
