...
_deprecated_file( basename( __FILE__ ), '15.0.0', '/wp-content/plugins/buddypress/bp-members/classes/class-bp-members-notices-list-table.php', esc_html__( 'Please use `BP_Members_Notices_List_Table` instead.', 'buddypress' ) );
