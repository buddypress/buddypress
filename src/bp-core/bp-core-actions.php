...
add_action( 'wp', 'bp_ready' );
add_action( 'set_current_user', 'bp_setup_current_user' );
add_action( 'setup_theme', 'bp_setup_theme' );
add_action( 'after_setup_theme', 'bp_after_setup_theme', 100 ); // After WP themes.
add_action( 'wp_enqueue_scripts', 'bp_enqueue_scripts' );
add_action( 'enqueue_embed_scripts', 'bp_enqueue_embed_scripts' );
add_action( 'admin_bar_menu', 'bp_setup_admin_bar', 20 ); // After WP core.
add_action( 'template_redirect', 'bp_template_redirect' );
add_action( 'widgets_init', 'bp_widgets_init' );
add_action( 'generate_rewrite_rules', 'bp_generate_rewrite_rules' );
...
add_action( 'bp_template_redirect', 'bp_post_request' );
add_action( 'bp_template_redirect', 'bp_get_request' );
...
add_action( 'bp_after_setup_theme', 'bp_register_theme_compat_default_features' );
