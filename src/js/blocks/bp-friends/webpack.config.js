...
module.exports = {
	...
	...{
        entry: {
            'dynamic-friends/index': './src/js/blocks/bp-friends/dynamic-friends/friends.js',
			'dynamic-widget/index': './src/js/blocks/bp-friends/dynamic-widget/friends.js',
        },
		output: {
			filename: '[name].js',
			path: path.join( __dirname, '..', '..', '..', '..', 'src', 'bp-friends', 'blocks' ),
		}
    },
	plugins: [
