...
module.exports = {
	...
	...{
        entry: {
            'embed-activity/index': './src/js/blocks/bp-activity/embed-activity/embed-activity.js',
			'latest-activities/index': './src/js/blocks/bp-activity/latest-activities/latest-activities.js',
        },
		output: {
			filename: '[name].js',
			path: path.join( __dirname, '..', '..', '..', '..', 'src', 'bp-activity', 'blocks' ),
		}
    },
	plugins: [
