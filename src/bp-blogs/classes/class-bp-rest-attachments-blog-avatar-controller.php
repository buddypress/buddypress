<?php
/**
 * BP_REST_Attachments_Blog_Avatar_Controller class
 *
 * @package BuddyPress
 * @since 6.0.0
 */
 ...
 * @since 6.0.0
 */
class BP_REST_Attachments_Blog_Avatar_Controller extends WP_REST_Controller {
	use BP_REST_Attachments;

	/**
	 * Reuse some parts of the BP_REST_Blogs_Controller class.
	 *
	 * @since 6.0.0
	 *
	 * @var BP_REST_Blogs_Controller
	 */
	...
	public function __construct() {
		...
		$this->blogs_endpoint = new BP_REST_Blogs_Controller();
	}
