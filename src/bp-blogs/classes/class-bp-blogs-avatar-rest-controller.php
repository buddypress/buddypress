<?php
/**
 * BP_Blogs_Avatar_REST_Controller class
 *
 * @package BuddyPress
 * @since 15.0.0
 */
 ...
 * @since 15.0.0
 */
class BP_Blogs_Avatar_REST_Controller extends WP_REST_Controller {
	use BP_REST_Attachments;

	/**
	 * Reuse some parts of the BP_REST_Blogs_REST_Controller class.
	 *
	 * @since 15.0.0
	 *
	 * @var BP_Blogs_REST_Controller
	 */
	...
	public function __construct() {
		...
		$this->blogs_endpoint = new BP_Blogs_REST_Controller();
	}
