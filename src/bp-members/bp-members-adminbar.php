 ...
 *
 * @since 11.4.0
 * @param array  $notifications Optional. Notifications to display.
 * @param string $menu_link     Optional. Notifications menu link.
 * @param string $type          Optional. Context in which to build the dropdown.
 */
