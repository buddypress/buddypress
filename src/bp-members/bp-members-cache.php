...
/**
 * Invalidate cache for member's notices.
 *
 * @since 15.0.0
 */
function bp_members_clear_user_notices_cache( $user_id = 0 ) {
...
add_action( 'bp_member_notice_dismissed', 'bp_members_clear_user_notices_cache' );
