<?php
/**
 * BP_REST_Members_Controller class
 *
 * @package BuddyPress
 * @since 5.0.0
 */
 ...
 * @since 5.0.0
 */
class BP_REST_Members_Controller extends WP_REST_Users_Controller {
	...
	protected function xprofile_data( $user_id ) {
		...
		if ( bp_is_active( 'xprofile' ) ) {
			$fields_endpoint = new BP_REST_XProfile_Fields_Controller();
