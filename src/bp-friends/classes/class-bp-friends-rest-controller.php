...
class BP_Friends_REST_Controller extends WP_REST_Controller {
	...
	public function get_endpoint_args_for_item_schema( $method = WP_REST_Server::CREATABLE ) {
		 ...
		 *
		 *  - `bp_rest_friends_get_item_query_arguments`
		 *  - `bp_rest_friends_create_item_query_arguments`
		 *  - `bp_rest_friends_update_item_query_arguments`
		 *  - `bp_rest_friends_delete_item_query_arguments`
		 *
		 * @since 15.0.0
		 *
