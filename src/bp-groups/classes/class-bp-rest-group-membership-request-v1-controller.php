 ...
 * @since 5.0.0
 */
class BP_REST_Group_Membership_Request_V1_Controller extends WP_REST_Controller {
	...
	public function __construct() {
		...
		$this->group_members_endpoint = new BP_REST_Group_Membership_V1_Controller();
		$this->invites_endpoint       = new BP_REST_Group_Invites_V1_Controller();
	}
