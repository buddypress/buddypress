<?php
/**
 * BP REST: BP_Groups_Membership_REST_Controller class
 *
 * @package BuddyPress
 * @since 15.0.0
 */
...
class BP_Groups_Membership_REST_Controller extends WP_REST_Controller {
	...
	/**
	 * Reuse some parts of the BP_Members_REST_Controller class.
	 *
	 * @since 15.0.0
	 *
	 * @var BP_Members_REST_Controller
	 */
	...
	public function __construct() {
		...
		$this->members_endpoint = new BP_Members_REST_Controller();
	}
