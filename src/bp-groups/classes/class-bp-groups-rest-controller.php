<?php
/**
 * BP REST: BP_Groups_REST_Controller class
 *
 * @package BuddyPress
 * @since 15.0.0
 */
...
class BP_Groups_REST_Controller extends WP_REST_Controller {
	...
	public function get_endpoint_args_for_item_schema( $method = WP_REST_Server::CREATABLE ) {
		 ...
		 *
		 *  - `bp_rest_groups_get_item_query_arguments`
		 *  - `bp_rest_groups_create_item_query_arguments`
		 *  - `bp_rest_groups_update_item_query_arguments`
		 *  - `bp_rest_groups_delete_item_query_arguments`
		 *
		 * @since 15.0.0
		 *
