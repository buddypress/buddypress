<?php
/**
 * BP REST: BP_Groups_Invites_REST_Controller class
 *
 * @package BuddyPress
 * @since 15.0.0
 */
...
class BP_Groups_Invites_REST_Controller extends WP_REST_Controller {
	...
	/**
	 * Reuse some parts of the BP_Groups_Membership_REST_Controller class.
	 *
	 * @since 15.0.0
	 *
	 * @var BP_Groups_Membership_REST_Controller
	 */
	protected $group_members_endpoint;
