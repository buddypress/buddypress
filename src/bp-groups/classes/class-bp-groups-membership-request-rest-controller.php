<?php
/**
 * BP REST: BP_Groups_Membership_Request_REST_Controller class
 *
 * @package BuddyPress
 * @since 15.0.0
 */
...
class BP_Groups_Membership_Request_REST_Controller extends WP_REST_Controller {
	...
	/**
	 * Reuse some parts of the BP_Groups_REST_Controller class.
	 *
	 * @since 15.0.0
	 *
	 * @var BP_Groups_REST_Controller
	 */
	protected $groups_endpoint;

	/**
	 * Reuse some parts of the BP_REST_Group_Invites_REST_Controller class.
	 *
	 * @since 15.0.0
	 *
	 * @var BP_REST_Group_Invites_REST_Controller
	 */
	...
	public function __construct() {
		...
		$this->groups_endpoint        = new BP_Groups_REST_Controller();
		$this->group_members_endpoint = new BP_Groups_Membership_REST_Controller();
		$this->invites_endpoint       = new BP_Groups_Invites_REST_Controller();
	}
