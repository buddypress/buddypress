...
<input type="text" name="group-name" id="group-name" value="<?php if ( bp_is_group_create() ) : ?><?php echo esc_attr( bp_get_new_group_name() ); ?><?php else : ?><?php echo esc_attr( bp_get_group_name() ); ?><?php endif; ?>" aria-required="true" />
