...
jQuery(document).ready( function() {
	...
	jQuery("input#send_reply_button").click( 
		function() {
			...
			jQuery("form#send-reply").before('<div style="display:none;" class="ajax_reply" id="' + rand + '"><img src="<?php echo WPMU_PLUGIN_URL . '/bp-messages/images/loading.gif' ?>" alt="Loading" /> &nbsp;Sending Message...</div>');
