...
function messages_add_js() {
	...
	if ( $bp['current_component'] == $bp['messages']['slug'] && $bp['current_action'] == 'compose') {
		wp_enqueue_script( 'bp-jquery-autocomplete', site_url() . '/wp-content/mu-plugins/bp-messages/js/autocomplete/jquery.autocomplete.js', 'jquery' );
		wp_enqueue_script( 'bp-jquery-autocomplete-fb', site_url() . '/wp-content/mu-plugins/bp-messages/js/autocomplete/jquery.autocompletefb.js', 'jquery' );
		wp_enqueue_script( 'bp-jquery-bgiframe', site_url() . '/wp-content/mu-plugins/bp-messages/js/autocomplete/jquery.bgiframe.min.js', 'jquery' );
		wp_enqueue_script( 'bp-jquery-dimensions', site_url() . '/wp-content/mu-plugins/bp-messages/js/autocomplete/jquery.dimensions.js', 'jquery' );	
		wp_enqueue_script( 'bp-autocomplete-init', site_url() . '/wp-content/mu-plugins/bp-messages/js/autocomplete/init.php', 'jquery' );	
...
function messages_add_css() {
	...
	if ( $bp['current_component'] == $bp['messages']['slug'] && $bp['current_action'] == 'compose') {
		wp_enqueue_style( 'bp-messages-autocomplete', site_url() . '/wp-content/mu-plugins/bp-messages/css/autocomplete/jquery.autocompletefb.css' );	
		wp_print_styles();
	}
}
