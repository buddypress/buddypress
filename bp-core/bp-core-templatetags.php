...
function bp_members_pagination_count() {
	...
	if ( 'active' == $members_template->type )
		echo sprintf( __( 'Viewing member %1$d to %2$d (of %3$d active members)', 'buddypress' ), $from_num, $to_num, $total );
	else if ( 'popular' == $members_template->type )
		echo sprintf( __( 'Viewing member %1$d to %2$d (of %3$d members with friends)', 'buddypress' ), $from_num, $to_num, $total );
	else if ( 'online' == $members_template->type )
		echo sprintf( __( 'Viewing member %1$d to %2$d (of %3$d members online)', 'buddypress' ), $from_num, $to_num, $total );
	else
		echo sprintf( __( 'Viewing member %1$d to %2$d (of %3$d members)', 'buddypress' ), $from_num, $to_num, $total );
