...
<div id="content">	
	...
	<div class="main-column">
		<div class="inner-tube">
			...
			<div class="bp-widget">
				<h4><?php _e( 'Forum', 'buddypress' ); ?> <?php if ( is_user_logged_in() ) : ?><span><a href="#post-new-topic" title="<?php _e( 'Post New', 'buddypress' ) ?>"><?php _e( 'Post New &rarr;', 'buddypress' ) ?></a></span><?php endif; ?></h4>
