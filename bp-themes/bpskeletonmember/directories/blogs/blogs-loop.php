<?php
/*
 * /directories/blogs/blogs-loop.php
 * The loop for displaying all the blogs site wide.
 * 
 * Loaded by: 'directories/blogs/index.php'
	...
	<?php while ( bp_site_blogs() ) : bp_the_site_blog(); ?>
		...
		<li>
			...
			<div class="action">
				...
				<?php do_action( 'bp_core_directory_blogs_actions' ) ?>
			</div>
