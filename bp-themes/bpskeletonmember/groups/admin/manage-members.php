<?php
/*
 * /groups/admin/manage-members.php
 * The settings screen for managing the members of a group (banning, promoting etc)
 *
 * Loaded on URL:
 * 'http://example.org/groups/[group-slug]/admin/manage-members/
 */
?>
