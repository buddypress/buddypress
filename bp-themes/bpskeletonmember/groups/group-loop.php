<?php
/*
 * /groups/group-loop.php
 * Used to loop the groups and display all the groups that a user has joined.
 * 
 * Loaded by: '/groups/index.php'
 *			  via AJAX on pagination clicks.
 */
?>
	...
	<?php if ( bp_has_groups() ) : ?>
		...
		<?php while ( bp_groups() ) : bp_the_group(); ?>
			...
			<li>
				...
				<h4><a href="<?php bp_group_permalink() ?>"><?php bp_group_name() ?></a><span class="small"> - <?php printf( __( '%s members', 'buddypress' ), bp_get_group_total_members() ) ?></span></h4>
