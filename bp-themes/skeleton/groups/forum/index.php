<?php
/*
 * /groups/forum/index.php
 * Displays all the forum topics for a group.
...
<div id="main">	
	...
	<div class="main-column">
		...
		<div class="info-group">
			<h4>
				<?php _e( 'Forum', 'buddypress' ); ?> 
				<span><a href="#post-new" title="<?php _e( 'Post New', 'buddypress' ) ?>"><?php _e( 'Post New &raquo;', 'buddypress' ) ?></a></span>
			</h4>
				...
				<?php if ( bp_has_topics() ) : ?>									
					...
					<?php while ( bp_topics() ) : bp_the_topic(); ?>
						...
						<li>
							...
							<p><span class="activity"><?php echo sprintf( __( 'updated %s ago', 'buddypress' ), bp_get_the_topic_time_since_last_post() ) ?></span></p>
