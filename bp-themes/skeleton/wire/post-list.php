...
/*
 * /wire/post-list.php
 * This displays the wire posts for a specific piece of content. It is loaded in
 * template files using the template tag 'bp_wire_get_post_list()' and passing the
 * variables that are needed including the item_id and whether the user can post or not.
 * 
 * Loaded by: 'groups/wire.php' (the group wire)
 *            'wire/latest.php' (the profile wire)
 */
?>
