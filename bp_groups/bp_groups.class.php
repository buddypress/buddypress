...
{	
	...
	function Groups()
	{
		include(ABSPATH."wp-content/mu-plugins/bp_groups/bp_groups.list.php");
	}
	
	// show the create group form
	function Create()
	{
		include(ABSPATH."wp-content/mu-plugins/bp_groups/bp_groups.create.php");
	}
	
	// show the edit group form
	function Edit()
	{
		include(ABSPATH."wp-content/mu-plugins/bp_groups/bp_groups.edit.php");
	}
	
	// show the invitations
	function Invites()
	{
		include(ABSPATH."wp-content/mu-plugins/bp_groups/bp_groups.invites.php");
	}
	
	// show the group join search form
	function Join()
	{
		include(ABSPATH."wp-content/mu-plugins/bp_groups/bp_groups.join.php");
	}
