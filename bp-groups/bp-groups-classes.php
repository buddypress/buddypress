...
Class BP_Groups_Group {
	...
	function get_total_group_count() {
		...
		return $wpdb->get_var( $wpdb->prepare( "SELECT COUNT(id) FROM {$bp->groups->table_name}" ) );
	}
