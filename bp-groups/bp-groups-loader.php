...
class BP_Groups_Component extends BP_Component {
	...
	function BP_Groups_Component() {
		parent::start( 'groups', __( 'User Groups', 'buddypress' ) );
	}
	...
	function _setup_globals() {
		...
		$this->root_slug = isset( $bp->pages->groups->slug ) ? $bp->pages->groups->slug : $this->slug;

		// Tables
		$this->table_name            = $bp->table_prefix . 'bp_groups';
		$this->table_name_members    = $bp->table_prefix . 'bp_groups_members';
		$this->table_name_groupmeta  = $bp->table_prefix . 'bp_groups_groupmeta';

		// Notifications
		$this->notification_callback = 'groups_format_notifications';
		...
		$bp->default_search_strings[$this->id] = __( 'Search Groups...', 'buddypress' );
	 ...
	 */
	function _includes() {
		require_once( BP_PLUGIN_DIR . '/bp-groups/bp-groups-cache.php'     );
		require_once( BP_PLUGIN_DIR . '/bp-groups/bp-groups-forums.php'    );
		require_once( BP_PLUGIN_DIR . '/bp-groups/bp-groups-actions.php'   );
		require_once( BP_PLUGIN_DIR . '/bp-groups/bp-groups-filters.php'   );
		require_once( BP_PLUGIN_DIR . '/bp-groups/bp-groups-screens.php'   );
		require_once( BP_PLUGIN_DIR . '/bp-groups/bp-groups-classes.php'   );
		require_once( BP_PLUGIN_DIR . '/bp-groups/bp-groups-widgets.php'   );
		require_once( BP_PLUGIN_DIR . '/bp-groups/bp-groups-activity.php'  );
		require_once( BP_PLUGIN_DIR . '/bp-groups/bp-groups-template.php'  );
		require_once( BP_PLUGIN_DIR . '/bp-groups/bp-groups-functions.php' );
	}
	...
	function _setup_nav() {
		...
		if ( bp_is_current_component( 'groups' ) && $group_id = BP_Groups_Group::group_exists( bp_current_action() ) ) {
