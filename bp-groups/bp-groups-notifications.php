...
function groups_notification_new_membership_request( $requesting_user_id, $admin_id, $group_id, $membership_id ) {
	...
	bp_users_add_notification( $requesting_user_id, $admin_id, 'groups', 'new_membership_request', $group_id );
...
function groups_notification_membership_request_completed( $requesting_user_id, $group_id, $accepted = true ) {
	...
	if ( $accepted )
		bp_users_add_notification( $group_id, $requesting_user_id, 'groups', 'membership_request_accepted' );
	else
		bp_users_add_notification( $group_id, $requesting_user_id, 'groups', 'membership_request_rejected' );
...
function groups_notification_promoted_member( $user_id, $group_id ) {
	...
	// Post a screen notification first.
	bp_users_add_notification( $group_id, $user_id, 'groups', $type );
...
function groups_notification_group_invites( &$group, &$member, $inviter_user_id ) {
	...
	if ( !$member->invite_sent ) {
		...
		// Post a screen notification first.
		bp_users_add_notification( $group->id, $invited_user_id, 'groups', 'group_invite' );
