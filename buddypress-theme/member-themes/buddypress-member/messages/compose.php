...
<div id="content">
	...
	<form action="<?php bp_messages_form_action('compose') ?>" method="post" id="send_message_form" class="standard-form">
		...
		<p class="submit">
				<input type="submit" value="<?php _e("Send", 'buddypress') ?> &raquo;" name="send" id="send" style="font-weight: bold" onclick="this.disabled = true; this.value = '<?php _e( 'Sending...', 'buddypress' ) ?>';" />
		</p>
	</div>
	</form>
