...
<div id="content">	
		...
		<form action="<?php bp_group_admin_form_action('delete-group') ?>" name="group-delete-form" id="group-delete-form" class="standard-form" method="post">
			...
			<input type="checkbox" name="delete-group-understand" id="delete-group-understand" value="1" onclick="if(this.checked) { document.getElementById('delete-group-button').disabled = ''; } else { document.getElementById('delete-group-button').disabled = 'disabled'; }" /> I understand the consequences of deleting this group.
