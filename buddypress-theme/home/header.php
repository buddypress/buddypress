...
<body>
	...
	<div id="header">		
		...
		<ul id="nav">
			...
			<!--
			<li><a href="<?php echo get_option('home') ?>/news" title="Home">News</a></li>
			<li><a href="<?php echo get_option('home') ?>/members" title="Home">Members</a></li>
			<li><a href="<?php echo get_option('home') ?>/groups" title="Home">Groups</a></li>
			<li><a href="<?php echo get_option('home') ?>/blogs" title="Home">Blogs</a></li>
			<li><a href="<?php echo get_option('home') ?>/forum" title="Home">Forum</a></li>
			-->
		</ul>
