...
function xprofile_admin($message = '', $type = 'error')
{
	...
	{
		if(bp_core_validate($_GET['group_id']) && bp_core_validate($_GET['field_id'])) {
		...
		if(bp_core_validate($_GET['field_id'])) {
...
function xprofile_admin_manage_group($group_id = null)
{
	...
	if(isset($_POST['saveGroup']))
	{
		...
		{
			$group->name = bp_core_clean($_POST['group_name']);
			$group->description = bp_core_clean($_POST['group_desc']);
...
function xprofile_admin_manage_field($group_id, $field_id = null)
{
	...
	if(isset($_POST['saveField']))
	{
		if(BP_XProfile_Field::admin_validate($_POST))
		{
			...
			$field->type = bp_core_clean($_POST['fieldtype']);
