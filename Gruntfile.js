...
module.exports = function( grunt ) {
	...
	grunt.initConfig( {
		...
		exec: {
			...
			cli: {
				command: 'svn export --force https://github.com/buddypress/wp-cli-buddypress.git/tags/1.8 cli',
				cwd: BUILD_DIR,
				stdout: false
			},
			phpcompat: {
			...
			rest_api: {
				command: 'svn export --force https://github.com/buddypress/BP-REST.git/branches/0.1 bp-rest',
				cwd: BUILD_DIR,
				stdout: false
			}
		},
