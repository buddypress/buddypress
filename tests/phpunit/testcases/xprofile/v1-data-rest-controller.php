<?php
/**
 * XProfile Data V1 Controller Tests.
 *
 * @package BuddyPress
 * @group xprofile
 * @group xprofile-data
 */
class BP_Test_REST_XProfile_Data_V1_Controller extends WP_Test_REST_Controller_Testcase {
	protected $endpoint;
	protected $bp;
	...
	public function set_up() {
		...
		$this->endpoint     = new BP_REST_XProfile_Data_V1_Controller();
		$this->field        = new BP_REST_XProfile_Fields_V1_Controller();
