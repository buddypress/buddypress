<?php
/**
 * XProfile Field Groups v1 Controller Tests.
 *
 * @package BuddyPress
 * @group xprofile
 * @group xprofile-group
 */
class BP_Test_REST_XProfile_Groups_V1_Controller extends WP_Test_REST_Controller_Testcase {
	protected $endpoint;
	protected $bp;
	...
	public function set_up() {
		...
		$this->endpoint     = new BP_REST_XProfile_Field_Groups_V1_Controller();
