<?php
/**
 * XProfile Field V1 Controller Tests.
 *
 * @package BuddyPress
 * @group xprofile
 * @group xprofile-field
 */
class BP_Test_REST_XProfile_Fields_V1_Controller extends WP_Test_REST_Controller_Testcase {
	protected $endpoint;
	protected $bp;
	...
	public function set_up() {
		...
		$this->endpoint     = new BP_REST_XProfile_Fields_V1_Controller();
