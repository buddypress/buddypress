<?php
/**
 * Group Membership V1 Controller Tests.
 *
 * @package BuddyPress
 * @group group-membership
 * @group groups
 */
class BP_Test_REST_Group_Membership_V1_Controller extends WP_Test_REST_Controller_Testcase {
	protected $endpoint;
	protected $bp;
	...
	public function set_up() {
		...
		$this->endpoint     = new BP_REST_Group_Membership_V1_Controller();
