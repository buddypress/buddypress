<?php
/**
 * Group Invites V1 Controller Tests.
 *
 * @package BuddyPress
 * @group group-invites
 */
class BP_Test_REST_Group_Invites_V1_Controller extends WP_Test_REST_Controller_Testcase {
	protected $endpoint;
	protected $bp;
	...
	public function set_up() {
		...
		$this->endpoint     = new BP_Test_REST_Group_Invites_V1_Controller();
