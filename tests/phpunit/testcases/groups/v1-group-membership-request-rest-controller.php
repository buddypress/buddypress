<?php
/**
 * Group Membership Request V1 Controller Tests.
 *
 * @package BuddyPress
 * @group group-membership-request
 * @group groups
 */
class BP_Test_REST_Group_Membership_Request_V1_Controller extends WP_Test_REST_Controller_Testcase {
	protected $endpoint;
	protected $bp;
	...
	public function set_up() {
		...
		$this->endpoint     = new BP_REST_Group_Membership_Request_V1_Controller();
