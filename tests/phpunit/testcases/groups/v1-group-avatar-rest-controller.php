<?php
/**
 * Group Avatar V1 Controller Tests.
 *
 * @package BuddyPress
 * @group groups
 * @group group-avatar
 */
class BP_Test_REST_Attachments_Group_Avatar_V1_Controller extends WP_Test_REST_Controller_Testcase {
	protected $endpoint;
	protected $bp;
	...
	public function set_up() {
		...
		$this->endpoint     = new BP_REST_Attachments_Group_Avatar_V1_Controller();
