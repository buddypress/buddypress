<?php
/**
 * Group V1 Controller Tests.
 *
 * @package BuddyPress
 * @group group
 */
class BP_Test_REST_Group_V1_Controller extends WP_Test_REST_Controller_Testcase {
	protected $endpoint;
	protected $bp;
	...
	public function set_up() {
		...
		$this->endpoint     = new BP_REST_Groups_V1_Controller();
