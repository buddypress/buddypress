 ...
 * @group member-cover
 */
class BP_Test_REST_Attachments_Member_Cover_Controller extends WP_Test_REST_Controller_Testcase {
	protected $endpoint;
	protected $bp;
	...
	public function set_up() {
		...
		$this->endpoint     = new BP_REST_Attachments_Member_Cover_Controller();
