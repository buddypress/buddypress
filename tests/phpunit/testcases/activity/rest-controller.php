 ...
 * @group activity
 */
class BP_Test_REST_Activity_Controller extends WP_Test_REST_Controller_Testcase {
	protected $endpoint;
	protected $bp;
	...
	public function set_up() {
		parent::set_up();
		$this->endpoint     = new BP_REST_Activity_Controller();
	...
	public function test_create_item_and_get_reply() {
		...
		$this->assertTrue( (int) $expected === (int) $get_data['comments'][0]['comments'][0]['id'] );
	}
	...
	public function test_create_item_and_get_comment_in_a_group() {
		...
		$get_data = $get_response->get_data();
		$this->assertSame( (int) $expected, (int) $get_data['comments'][0]['id'] );
	}
