<?php
/**
 * Activity V1 Controller Tests.
 *
 * @package BuddyPress
 * @group activity
 */
class BP_Test_REST_Activity_V1_Controller extends WP_Test_REST_Controller_Testcase {
	protected $endpoint;
	protected $bp;
	...
	public function set_up() {
		parent::set_up();
		$this->endpoint     = new BP_REST_Activity_V1_Controller();
