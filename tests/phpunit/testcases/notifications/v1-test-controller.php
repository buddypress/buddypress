<?php
/**
 * Notifications V1 Controller Tests.
 *
 * @package BuddyPress
 * @group notifications
 */
class BP_Test_REST_Notifications_V1_Controller extends WP_Test_REST_Controller_Testcase {
	protected $endpoint;
	protected $bp;
	...
	public function set_up() {
		...
		$this->endpoint        = new BP_REST_Notifications_V1_Controller();
