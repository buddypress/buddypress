<?php
/**
 * Friends V1 Controller Tests.
 *
 * @package BuddyPress
 * @group friends
 */
class BP_Test_REST_Friends_V1_Controller extends WP_Test_REST_Controller_Testcase {
	protected $endpoint;
	protected $bp;
	...
	public function set_up() {
		...
		$this->endpoint     = new BP_REST_Friends_V1_Controller();
