...
/**************************************************************************
 ...
 Description: 
 Alows site owners to dictate what users can add to their profile by
 creating custom fields. Also alows users to update their profiles
 and add a profile picture (avatar).
...
function xprofile_install()
{
	...
	$sql[0] = "CREATE TABLE `". $bp_xprofile_table_name ."_groups` (
	...
	$sql[1] = "CREATE TABLE `". $bp_xprofile_table_name ."_fields` (
			  `id` int(11) unsigned NOT NULL auto_increment,
	...
	$sql[2] = "CREATE TABLE `". $bp_xprofile_table_name ."_data` (
			  `id` int(11) unsigned NOT NULL auto_increment,
	...
	$sql[3] = "INSERT INTO `". $bp_xprofile_table_name ."_groups` VALUES (1, 'Basic', '', 0);";
	$sql[4] = "INSERT INTO `". $bp_xprofile_table_name ."_fields` VALUES (1, 1, 0, 'textbox', 'First Name', '', 1, 0);";
	$sql[5] = "INSERT INTO `". $bp_xprofile_table_name ."_fields` VALUES (2, 1, 0, 'textbox', 'Last Name', '', 1, 0);";
