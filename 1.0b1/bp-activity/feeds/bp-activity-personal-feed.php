...
<channel>
	<title><?php echo $bp['current_fullname']; ?> - <?php _e( 'Activity', 'buddypress' ) ?></title>
	<atom:link href="<?php self_link(); ?>" rel="self" type="application/rss+xml" />
	<link><?php echo $bp['current_domain'] . $bp['activity']['slug'] . '/feed' ?></link>
	<description><?php _e( sprintf( '%s - Activity Feed', $bp['current_fullname'] ), 'buddypress' ) ?></description>
